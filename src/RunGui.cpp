            ...
            const Args &args, Updates &updates)
{
    ...
    a.setStyleSheet(
        "QMenu{background:#101013;border:1px solid #2a2a2f;padding:4px;}"
        "QMenu::item{padding:5px 24px;color:#e8e8ea;border-radius:4px;}"
        "QMenu::item:selected{background:#29b6f6;color:#0c0c0e;}"
        "QMenu::separator{height:1px;background:#2a2a2f;margin:4px 8px;}");
